...
try
{
    ...
    var streamClient = new StreamClient<MarketRunnerBatTVLTP>("stream-api.betfair.com", 443, session.AppKey, session.Token, logger, streamDumper);
    ...
    SteamerService<MarketRunnerBatTVLTP> steamerService = new SteamerService<MarketRunnerBatTVLTP>(betfairAsyncClient, streamClient, logger, cts.Token, 1);
