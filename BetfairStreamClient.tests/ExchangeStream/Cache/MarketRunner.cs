...
namespace BetfairStreamClient.tests.ExchangeStream.Cache
{
    ...
    public class MarketRunner
    {
        ...
        private double _ltp;
        private double _tv;
        private Model.RunnerDefinition _runnerDefinition;
        private Cache.MarketRunnerSnap _snap;
        ...
        internal void OnPriceChange(bool isImage, Model.RunnerChange runnerChange)
        {
            //snap is invalid
            _snap = null;
        ...
        internal void OnRunnerDefinitionChange(Model.RunnerDefinition runnerDefinition)
        {
            //snap is invalid
            _snap = null;
        ...
        /// </summary>
        public Cache.MarketRunnerSnap Snap
        {
            get
            {
                if (_snap == null)
                {
                    _snap = new Cache.MarketRunnerSnap()
                    {
                        RunnerId = RunnerId,
