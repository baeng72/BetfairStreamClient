...
namespace BetfairStreamClient.tests.ExchangeStream.Cache
{
    ...
    public class OrderMarket
    {
        ...
        internal void OnOrderMarketChange(Model.OrderMarketChange orderMarketChange)
        {
            ...
            {
                //runners changed
                foreach (Model.OrderRunnerChange orderRunnerChange in orderMarketChange.Orc)
                {
        ...
        private void OnOrderRunnerChange(Model.OrderRunnerChange orderRunnerChange)
        {
