...
namespace BetfairStreamClient.tests.ExchangeStream.Model
{
    /// <summary>
    /// </summary>
    [DataContract]
    public class Order : IEquatable<Order>
    {
        ...
        ///  Reference Order
        /// </summary>
        [DataMember(Name = "rfo", EmitDefaultValue = false)]
        public string Rfo { get; set; }

        [DataMember(Name = "rfs", EmitDefaultValue = false)]
        ...
        public bool Equals(Order other)
        {
            ...
            return (Side == other.Side || Side != null && Side.Equals(other.Side)) &&
                   ...
                   (Rfo == other.Rfo || Rfo != null && Rfo.Equals(other.Rfo)) &&
                   (Rfs == other.Rfs || Rfs != null && Rfs.Equals(other.Rfs)));
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (Rfo != null)
                    hash = hash * 59 + Rfo.GetHashCode();

                if (Rfs != null)
                    hash = hash * 59 + Rfs.GetHashCode();
                return hash;
            }
        }
    }
